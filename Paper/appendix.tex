...
\begin{figure}[h]
    \centering
       \subfloat[Location]{%
          \includegraphics[width=0.5\columnwidth]{figures/location_prune.pdf}%
          \label{fig:1left}%
       }
       \subfloat[Purchase]{%
          \includegraphics[width=0.5\columnwidth]{figures/purchase_prune.pdf}%
          \label{fig:1middle}%
       }
       \caption{Impact of Pruning on Membership Leakage.}
       \label{fig:xprune}
\end{figure}
...
\begin{figure}[h]
    \centering
       \subfloat[Location]{%
          \includegraphics[width=0.5\columnwidth]{figures/location_retrain.pdf}%
          \label{fig:2left}%
       }
       \subfloat[Purchase]{%
          \includegraphics[width=0.5\columnwidth]{figures/purchase_retrain.pdf}%
          \label{fig:2middle}%
       }
       \caption{Impact of Retraining on Membership Leakage.}
       \label{fig:xretrain}
\end{figure}
...
\begin{figure}[h]
    \centering
       \subfloat[Location]{%
          \includegraphics[width=0.5\columnwidth]{figures/location_wtsharing.pdf}%
          \label{fig:3left}%
       }
       \subfloat[Purchase]{%
          \includegraphics[width=0.5\columnwidth]{figures/purchase_wtsharing.pdf}%
          \label{fig:3middle}%
       }
       \caption{Mitigating Leakage via Weight sharing.}
       \label{fig:xwtsharing}
\end{figure}
