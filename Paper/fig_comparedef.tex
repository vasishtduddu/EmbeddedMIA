...
\caption{\method\hspace{0.02in} models are comparable to prior state of the art privacy defences in terms of test accuracy and inference accuracy while additionally ensuring efficiency.}
\label{fig:compare}
\end{center}
\end{figure}
