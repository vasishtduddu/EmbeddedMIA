...
\author{Vasisht Duddu$^1$, Virat Shejwalkar$^2$, $^1$}
\affiliation{\institution{$^1$ \large inst\\ $^2$ \large University of Massachusetts Amherst}}
\email{vduddu@tutamail.com, vshejwalkar@cs.umass.edu, ...}
