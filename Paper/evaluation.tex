\section{Evaluation}\label{compare}
...
The evaluation is done on state of the art standard architectures: Network in Network, AlexNet and VGGNet, on CIFAR10 dataset.
...
\textbf{add plot for generalization error cdf}
